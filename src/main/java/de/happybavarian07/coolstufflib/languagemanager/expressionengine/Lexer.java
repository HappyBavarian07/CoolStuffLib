...
public class Lexer {
     ...
     * @throws ExpressionSyntaxException If the source contains invalid or unexpected characters
     */
        ...
        switch (c) {
            ...
            default:
                if (isDigit(c)) {
                    ...
                    throw new ExpressionSyntaxException("Unexpected character: " + c);
                }
                break;
        }
    }
    ...
    private void string(char delimiter) {
        ...
        if (isAtEnd()) {
            throw new ExpressionSyntaxException("Unterminated string.");
        }
