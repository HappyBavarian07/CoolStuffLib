...
public class LanguageFunctionManager {
     ...
     * 
     * @param expressionEngine The expression parser instance to manage functions for
     */
    public LanguageFunctionManager(ExpressionEngine expressionEngine) {
    ...
    private void registerDefaultFunctions() {
        ...
        expressionEngine.registerFunction("hasPermission", (interp, args, callType) -> {
            if (args.size() != 2) {
        ...
        expressionEngine.registerFunction("hasItem", (interp, args, callType) -> {
        ...
        expressionEngine.registerFunction("random", (interp, args, callType) -> {
            if (args.size() != 2) {
    ...
    public void registerFunction(String functionString) {
        ...
        registerFunction(name, (interpreter, args, callType) -> {
            ...
            Object result;
            try {
                result = interpreter.interpret(expressionEngine.parse(body, Parser.Expression.class));
            } finally {
    ...
    public void registerFunction(String name, FunctionCall function, String defaultType) {
        expressionEngine.registerFunction(name, function, defaultType);
    }
    ...
    public void unregisterFunction(String name) {
        expressionEngine.unregisterFunction(name);
    }
    ...
    public void clearFunctions() {
        expressionEngine.clearFunctions();
    }
}
